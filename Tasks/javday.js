...
******************************************
BoxJs订阅地址:
 - https://raw.githubusercontent.com/onerootman/X/main/Tasks/boxjs.json
******************************************
Surge配置:
[Script]
𝐉𝐀𝐕𝐃𝐚𝐲每日推荐 = type=cron,cronexp=0 22 * * *,wake-system=1,script-path=https://raw.githubusercontent.com/onerootman/X/main/Tasks/javday.js,timeout=60
******************************************
青龙配置:
# 是否开启调试模式
